...
public final class ArsSkyConfig {
    ...
    public static final ForgeConfigSpec.EnumValue<RenderMode> MODE;
    public static final ForgeConfigSpec.BooleanValue TOP_MARKER;
    public static final ForgeConfigSpec.IntValue TOP_R;
    public static final ForgeConfigSpec.IntValue TOP_G;
    public static final ForgeConfigSpec.IntValue TOP_B;

    static {
        ForgeConfigSpec.Builder builder = new ForgeConfigSpec.Builder();
        MODE = builder
            .comment(
                "How the Ars Nouveau Sky Block is drawn while an Oculus shaderpack is active.",
