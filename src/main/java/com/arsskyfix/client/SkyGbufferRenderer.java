...
// entity-solid shader, which Iris routes (during the block-entity render) via ShaderKey.BLOCK_ENTITY to
// gbuffers_block at real depth -> universal occlusion + blockEntityId marker (set by Iris from
